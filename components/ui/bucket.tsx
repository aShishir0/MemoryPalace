...
const INITIAL_CHIPS = [
  {
    id: 1,
    title: "Reading Notes",
    description: "Analyzing your source material",
    icon: SecurityCheckIcon,
  },
  {
    id: 2,
    title: "Spatial Mapping",
    description: "Placing concepts in the hall",
    icon: ZapIcon,
  },
  {
    id: 3,
    title: "Synthesizing MNMNCS",
    description: "Crafting vivid associations",
    icon: UserStoryIcon,
  },
  {
    id: 4,
    title: "AI Ready",
    description: "Finalizing your learning palace",
    icon: SparklesIcon,
  },
];
